import { restaurants } from '../../double/in-memory-repository/restaurants.in-memory'
import chooseRestaurant from '../../../src/application/usecase/choose-restaurant.usecase'
